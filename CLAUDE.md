...
**Performance (Dynamic)** (`ai.rever.boss.plugin.dynamic.performance`) is a dynamic plugin for the BOSS desktop application.

Displays JVM metrics, CPU, memory, and resource counts

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.performance`
- **Main Class**: `ai.rever.boss.plugin.dynamic.performance.PerformanceDynamicPlugin`
- **API Version**: 1.0.20
